...
def run_inception_stepper(log, task_id, dry_run=False):
    report_data = []
    if dry_run:
...
if __name__ == '__main__':
    ...
    with open('result_index.json') as index_file:
    ...
    job_prefix = 'run_'
    if 'job_prefix' in index:
        job_prefix = index['job_prefix']
    ...
    sorted_table = run_inception_stepper(log, task_id, dry_run=dry_run)
